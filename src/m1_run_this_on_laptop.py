...
def main():
    ...
    grid_frames(teleop_frame, arm_frame, control_frame, drive_frame, sound_frame, find_object_frame)
...
def grid_frames(teleop_frame, arm_frame, control_frame, drive_frame, sound_frame, find_object_frame):
